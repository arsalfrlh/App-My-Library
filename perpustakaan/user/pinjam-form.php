      ...
      <?php
        ...
        <div class="main-user-info">
          ...
          <div class="user-input-box">
            ...
            <input type="date" id="tanggal" name="tgl_pinjam" readonly/>
            <input type="date" name="tgl_kembali" hidden="hidden" readonly/>
            <input type="hidden" value="konfirmasi" name="status" readonly/>
            <input type="hidden" name="id_user" value="<?php echo $id_user ?>" readonly/>
            <input type="hidden" name="id_buku" value="<?php echo $pinjam['bukuid'] ?>" readonly/>
