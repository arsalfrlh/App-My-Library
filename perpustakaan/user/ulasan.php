...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <h2 align="center">Ulasan Anda</h2>
      <a href="ulasan-all.php" class="btn btn-primary">Semua Ulasan</a>
      ...
      <table class="table table-striped table-sm">
        ...
        <tbody>
            <?php
            $id = $_SESSION['userid'];
            $result = mysqli_query($connect,"SELECT * FROM ulasanbuku LEFT JOIN user ON user.userid = ulasanbuku.userid LEFT JOIN buku ON buku.bukuid = ulasanbuku.bukuid WHERE ulasanbuku.userid='$id'");
            $no = 1;
            ...
            <td>
              ...
              <a class="btn btn-primary" href="ubah-ulasan.php?id=<?php echo $ulasan['ulasanid']; ?>">Edit</a>
              <a class="btn btn-danger" href="ulasan-hapus.php?id=<?php echo $ulasan['ulasanid']; ?>">Hapus</a></td>
            </tr>
            <?php
            }
            ?>
